...
{
    /// <summary>
    /// Cette classe regroupe les paramètres qui décrivent
    /// le comportement du logiciel.
    /// </summary>
    public sealed class Paramètres
    {
        public bool
            inclureLesSousRépertoires,
            supprimerLesSources;

        public Format
            formatDEntrée = Format.Bmp,
        ...
        /// <summary>
        /// Initialise les paramètres par défaut du logiciel.
        /// </summary>
        public Paramètres()
        {
            inclureLesSousRépertoires = true;
